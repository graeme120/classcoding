$(document).ready(function () {
  ...
  var button = document.getElementById("scrap1");
  button.addEventListener("click", mePlay);
  function mePlay() {
    var a = document.getElementById("collect");
    a.play();
  }

  var button = document.getElementById("scrap2");
  button.addEventListener("click", mePlay);
  function mePlay() {
    var a = document.getElementById("collect");
    a.play();
  ...
  var button = document.getElementById("scrap3");
  button.addEventListener("click", mePlay);
  function mePlay() {
    var a = document.getElementById("collect");
    a.play();
  ...
  var button = document.getElementById("scrap4");
  button.addEventListener("click", mePlay);
  function mePlay() {
    var a = document.getElementById("collect");
    a.play();
  ...
  var button = document.getElementById("scrap5");
  button.addEventListener("click", mePlay);
  function mePlay() {
    var a = document.getElementById("collect");
    a.play();
  ...
  var button = document.getElementById("scrap6");
  button.addEventListener("click", mePlay);
  function mePlay() {
    var a = document.getElementById("collect");
    a.play();
  ...
  var button = document.getElementById("scrap7");
  button.addEventListener("click", mePlay);
  function mePlay() {
    var a = document.getElementById("collect");
    a.play();
